...
This \CoreTerm{} is still assembled manually in many settings: researchers coordinate compute, references, manuscript tooling, and feedback workflows across separate systems~\citep{lu2024aiscientist,schmidgall2025agentrxiv}.
