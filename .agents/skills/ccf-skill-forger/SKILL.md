...
description: Design, create, update, validate, and audit skills, trigger wording, resources, references, scripts, path privacy, and family governance. Use for skill maintenance, new skill creation, routing conflict cleanup, and release validation. Do not perform research writing or review work.
---

# CCF Skill Forger (bundled)
...
May create candidate skills, but cannot mutate the pinned vendor snapshots silently.
