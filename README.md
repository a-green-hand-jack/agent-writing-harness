...
Pull requests must pass `harness`, `references`, `vendored-skills`, four real-TeX variant jobs, `paper-only`, `official-templates`, and `release-package`. See `CONTRIBUTING.md`.
